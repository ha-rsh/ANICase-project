...
interface DesignConfiuratiorProps {
  configId: string;
  imageUrl: string;
  imageDimensions: { width: number; height: number };
}

const DesignConfiguratior = ({configId, imageUrl, imageDimensions} : DesignConfiuratiorProps) => {
    ...
    async function saveConfiguration() {
      try {
        ...
        const blob = base64ToBlob(base64Data, "image/png") // convert base64 image into an actual png image.
    ...
    return (
      <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
          ...
          <Rnd
            ...
            onResizeStop={(_, __, ref, ___, {x,y}) => {
              setRenderedDimension({
                // 50px --> px is not required so slice it.
        ...
        <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
          <ScrollArea className="relative fle-1 overflow-auto">
            <div
              aria-hidden="true"
